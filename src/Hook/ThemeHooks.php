...
namespace Drupal\palcera_theme\Hook;
...
use Drupal\palcera_theme\RenderCallbacks;
...
/**
 * Contains hook implementations for PalceraTheme.
 */
final class ThemeHooks {
  ...
  public function preprocessHtml(array &$variables): void {
    ...
    $variables['palcera_theme_path'] = $this->requestStack->getCurrentRequest()->getBasePath() . '/' . $this->themeList->getPath('palcera_theme');
  }
